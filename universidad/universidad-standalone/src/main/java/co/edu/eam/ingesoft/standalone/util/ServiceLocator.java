package co.edu.eam.ingesoft.standalone.util;
...
public class ServiceLocator {
	...
	private static final String APP_NAME = "universidad1";
	private static final String MODULE_NAME = "universidad-negocio1";
